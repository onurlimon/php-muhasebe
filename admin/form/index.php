							...
							<tbody>
								<?php while($list = $query->fetch_object()): ?>
									<tr onclick="location.href='<?php site_url('form', $list->id); ?>';" class="pointer">
										...
										<td><a href="<?php site_url('form', $list->id); ?>" title="" style="text-decoration:none;">#<?php echo $list->id; ?></a></td>
										<td><a href="<?php site_url('account', $list->account_id); ?>" title="<?php echo $list->account_name; ?>" style="text-decoration:none;"><?php echo extra_get_substr($list->account_name,0,30); ?></a></td>
