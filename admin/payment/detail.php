...
//echo get_in_out_label($payment->in_out);
//exit();
...
<ul class="nav nav-tabs extra-nav-page" role="tablist"> 
	...
	<?php if($payment->id): ?>
		...
		<li class="dropdown pull-right extra-menu-right"><a href="print.php?id=<?php echo $payment->id; ?>&print" target="_blank" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-print"></i><span class="hidden-xs"> Yazdır </span><span class="caret"></span></a>
			<ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents"> 
	...
	<div class="tab-pane fade active in" role="tabpanel" id="home" aria-labelledby="home-tab"> 
		...
		<form name="form_payment" id="form_payment" action="" method="POST">
			...
			<div class="text-right">
				...
				<button class="btn btn-primary btn-xs-block btn-insert"><i class="fa fa-save"></i> Kaydet</button>
			</div>
