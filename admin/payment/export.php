...
<meta charset="UTF-8">
<title>Form Listesi | Extra</title>
<?php
...
<?php if($forms): ?>
		...
		<table class="table table-hover table-bordered table-condensed">
			...
			<?php foreach($forms->list as $form): ?>
				...
				<tr>
					...
					<td class="fs-11 text-muted"><?php if($form->in_out == '1'){ echo "Cikis"; } else { echo "Giris"; } ?></td>
					...
					?>
					<td class="text-center"><span class="text-muted"  data-toggle="tooltip" data-placement="top"><?php echo $city['city']; ?></span></td>
	...
	<?php else: ?>
		<table>
			...
			<?php endforeach; ?>
			<tr>
				<td colspan="7" style="color:#ccc; font-size:10px;"><?php echo get_convert_str_export('Onur Limon'); ?></td>
			</tr>
		</table>
	<?php endif; ?>
