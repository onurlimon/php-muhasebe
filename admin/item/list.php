	...
	<?php if($items): ?>
		<table class="table table-hover table-bordered table-condensed table-striped">
			<thead>
				...
				<?php else : ?>
					<tr>
						...
						<th>Ürün Adı <?php echo get_table_order_by('name', 'ASC'); ?></th>
						<th width="120">Maliyet Fiyatı <?php echo get_table_order_by('p_purc', 'ASC'); ?></th>
			...
			<?php foreach($items->list as $item): ?>
				<?php if( extra_is_mobile() ): ?>
					<tr>
						<td><a href="detail.php?id=<?php echo $item->id; ?>" class="fs-11" style="text-decoration:none;"><?php echo extra_get_substr($item->name,0,20); ?></a></td>
						<td class="text-right"><a href="detail.php?id=<?php echo $item->id; ?>" style="text-decoration:none;"><?php set_money($item->p_purc, true); ?></a></td>
						<td class="text-right"><a href="detail.php?id=<?php echo $item->id; ?>" style="text-decoration:none;"><?php set_money($item->p_sale, true); ?></a></td>
						<td class="text-center"><a href="detail.php?id=<?php echo $item->id; ?>" style="text-decoration:none;"><?php echo $item->quantity; ?></a></td>
					</tr>
				<?php else : ?>
					<tr>
						<td><a href="detail.php?id=<?php echo $item->id; ?>" style="text-decoration:none;"><?php echo $item->code; ?></a></td>
						<td><a href="detail.php?id=<?php echo $item->id; ?>" style="text-decoration:none;"><?php echo $item->name; ?></a></td>
						<td class="text-right"><a href="detail.php?id=<?php echo $item->id; ?>" style="text-decoration:none;"><?php set_money($item->p_purc, true); ?></a></td>
						<td class="text-right"><a href="detail.php?id=<?php echo $item->id; ?>" style="text-decoration:none;"><?php set_money($item->p_sale, true); ?></a></td>
						<td class="text-center"><a href="detail.php?id=<?php echo $item->id; ?>" style="text-decoration:none;"><?php echo $item->quantity; ?></a></td>
					</tr>
