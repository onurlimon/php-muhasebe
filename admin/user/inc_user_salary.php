						...
						<?php foreach($monthlys as $monthly): ?>
							<?php if($monthly->type == 'payment'): ?>
								<tr>
									...
									<td><?php echo extra_get_date($monthly->date, 'datetime'); ?></td>
									<td class="hidden-xs">
										<?php if($monthly->type == 'payment'): ?>
											Ödeme
										<?php else: ?>
											<?php echo extra_get_date($monthly->date, 'F Y'); ?> dönem hakediş
										<?php endif; ?>
									</td>
							...
							<?php else: ?>
								<tr>
									...
									<td><?php echo extra_get_date($monthly->date, 'datetime'); ?></td>
									<td class="hidden-xs">
										<?php echo extra_get_date($monthly->date, 'F Y'); ?> dönem hakediş, <?php echo get_set_money($monthly->val_decimal, 'icon'); ?> üzerinden
									</td>
									<td class="text-right"><?php if($monthly->type == 'salary'): ?><?php echo get_set_money($monthly->total, 'icon'); ?><?php endif; ?></td>
									<td class="text-right"><?php if($monthly->type == 'payment'): ?><?php echo get_set_money($monthly->total, 'icon'); ?><?php endif; ?></td>
								</tr>
