...
if(isset($_POST['update_profile']) and user_access('admin')) {
	...
	if(!isset($_POST['extra_login'])) {
		$_user['extra_login'] = false;
	}
...
if(isset($_POST['update_notes'])) {
	...
	$_profile['title'] = $_POST['title'];
	$_profile['notes'] 		= $_POST['notes'];
	
	update_user($user->id, $_profile);
}



## eger yukarıdaki guncelle yapilmis ise bilgileri tekrar alalim diye bilgileri tekrar aliyoruz
...
<ul class="nav nav-tabs" role="tablist"> 
	...
	<?php if(user_access('admin')): ?><li role="presentation" class=""><a href="#notes" role="tab" id="notes-tab" data-toggle="tab" aria-controls="notes" aria-expanded="false"><i class="fa fa-database"></i>Not</a></li> <?php endif; ?>
...
<div class="tab-content"> 
				...
				<?php if(user_access('admin')): ?>
					<div class="form-group">
						<label for="extra_login" id="label_extra_login">
							<input type="checkbox" name="extra_login" id="extra_login" value="1" <?php echo $user->extra_login ? 'checked' : ''; ?>>
	...
	<!-- /tab:cv -->
<!-- /tab:notes -->
	<div class="tab-pane" role="tabpanel" id="notes" aria-labelledby="logs-notes"> 
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="text" name="title" id="title" value="<?php echo $user->title; ?>" class="form-control" minlength="3" maxlength="20">
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label for="notes">Notlarım</label>
							<textarea type="text" name="notes" id="notes" class="form-control" minlength="3" maxlength="20"><?php echo $user->notes; ?></textarea>
						</div>
					</div>
				</div>

				<div class="pull-right hidden-xs">
					<input type="hidden" name="update_notes">
					<input type="hidden" name="uniquetime" value="<?php uniquetime(); ?>">
