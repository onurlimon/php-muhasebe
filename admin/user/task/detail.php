							...
							<div class="row space-5">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="date_start" id="date_start" class="form-control datetime" value="<?php echo extra_get_date($task->date_start, 'datetime'); ?>" <?php if($task->sen_u_id != get_active_user('id')): ?>  <?php endif; ?> >
									</div> <!-- /.form-group -->
								</div> <!-- /.col-md-6 -->
								<div class="col-md-6">
									<div class="form-group">
										<label for="date_end">Bitirme Tarihi</label>
										<input type="text" name="date_end" id="date_end" class="form-control datetime" value="<?php echo extra_get_date($task->date_end, 'datetime'); ?>" <?php if($task->sen_u_id != get_active_user('id')): ?>  <?php endif; ?> >
									</div> <!-- /.form-group -->
								</div> <!-- /.col-md-6 -->
							</div> <!-- /.row -->
												...
												<div class="message-elem-content">
													<div class="well padding-10 br-3">
														<div class="text-muted fs-11 italic">
															<span class="bold username"><?php echo get_user_info($message->sen_u_id, 'name'); ?> <?php echo get_user_info($message->sen_u_id, 'surname'); ?></span> <span class="inform-text">tarafından</span> <span class="bold date-tooltip" <?php if ( extra_is_mobile() ) { echo 'data-wenk-pos="left"'; } ?> data-wenk="<?php echo substr($message->date,0,16); ?>" title="<?php echo substr($message->date,0,16); ?>"><?php echo get_time_late($message->date); ?></span> <span class="inform-text">önce gönderildi.</span>
														</div><!--/ .text-muted /-->
