...
<div class="print-page" size="A4">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="text-right"><small class="text-muted"><?php echo extra_get_date(true, 'datetime'); ?></small></div>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="pull-right">
				<img src="<?php barcode_url('EXTRA-'.$user->id); ?>" />
				<br />
				<span class="pull-right mr-15"><?php echo 'EXTRA-'.$user->id; ?></span>
			</div>
				...
				<table class="table table-bordered table-condensed table-hover" style="font-size:12px;">
					...
					<?php foreach($monthlys as $monthly): ?>
									...
									<td>
										<small class="text-muted">
											...
											<?php elseif($item->item_name == 'overtime'): ?>
												<?php echo extra_get_date($item->val_date,'date'); ?>
						...
						<tr>
							...
							<td class="fs-11"><?php echo extra_get_date($monthly->date, 'datetime'); ?></td>
							<td>
								<?php if($monthly->type == 'payment'): ?>
									Ödeme
								<?php else: ?>
									<?php echo extra_get_date($monthly->date, 'str: F Y'); ?> dönem hakediş
								<?php endif; ?>
							</td>
							<td></td>
							<td></td>
	...
	<div class="print-footer print-footer-right text-center">
		<small class="text-muted">Bu belge <?php echo get_active_user('display_name'); ?> tarafından, <?php echo extra_get_date(true, 'datetime'); ?> tarihinde oluşturuldu.</small>
		<br /> 
	</div>
