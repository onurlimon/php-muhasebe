		...
		<table class="table table-hover table-bordered table-condensed table-striped">
			<thead>
				<tr>
					...
					<th class="hidden-xs" width="120">Sabit Telefon <?php echo get_table_order_by('phone', 'ASC'); ?></th>
			...
			<?php foreach($accounts->list as $account): ?>
				<tr>
					<td class="hidden-xs"><a href="detail.php?id=<?php echo $account->id; ?>" style="text-decoration:none;"><?php echo $account->code; ?></a></td>
					<td><a href="detail.php?id=<?php echo $account->id; ?>" style="text-decoration:none;"><?php echo $account->name; ?></a></td>
					<td><a href="detail.php?id=<?php echo $account->id; ?>" style="text-decoration:none;"><?php echo $account->gsm; ?></a></td>
					<td class="hidden-xs"><a href="detail.php?id=<?php echo $account->id; ?>" style="text-decoration:none;"><?php echo $account->phone; ?></a></td>
					<td class="hidden-xs"><a href="detail.php?id=<?php echo $account->id; ?>" style="text-decoration:none;"><?php echo $account->city; ?></a></td>
					<td class="text-right"><a href="detail.php?id=<?php echo $account->id; ?>" style="text-decoration:none;"><?php echo get_set_money($account->balance, true); ?></a></td>
				</tr>
			<?php endforeach; ?>
			</tbody>
		</table>
